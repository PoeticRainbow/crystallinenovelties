...
public class PurifyItem extends Item {
    public PurifyItem(Settings properties) {
    ...
    public TypedActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        playerIn.addChatMessage(new TranslatableText("item.crystallinenovelty.purity_charm.use"), true);
